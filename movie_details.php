    ...
    <div class="modal-content">
      <embed style="width: 820px; height: 450px;" src="<?php echo $row['you_tube_link'];?>"></embed>
        ...
        if (mysqli_num_rows($res) > 0) {
          while($row_time = mysqli_fetch_array($res)) {

            if(in_array($row_time['show'],$set_time)){

              ?><a href="seatbooking.php?movie=<?php echo $movie; ?>&time=<?php echo $row_time['show'];?>"><?php echo $row_time['show'];?></a><?php
