   ...
   <script type="text/javascript">
        ...
        $(document).ready(function(){
            $('.larger').click(function(){
                ...
                var totalprice = 0;
                var silver = ["I1", "I2", "I3", "I4", "I5", "I6", "I7", "I8", "I9", "I10", "I11", "I12",
                                "H1", "H2", "H3", "H4", "H5", "H6", "H7", "H8", "H9", "H10", "H11", "H12",
                                "G1", "G2", "G3", "G4", "G5", "G6", "G7", "G8", "G9", "G10", "G11", "G12"];
                var platinum = ["A1", "A2", "A3", "A4", "A5", "A6", "A7", "A8", "A9", "A10", "A11", "A12"]; 
                //var platinum = "A1,A2,A3,A4,A5,A6,A7,A8,A9,A10,A11,A12";
                if(count < 7)
                {
                    $('.larger:checked').each(function(){
                        ...
                        if(silver.includes($(this).val())){
                            totalprice += 100000;
                        }
                        else if(platinum.includes($(this).val())){
                            totalprice += 200000;
                        }
                        else{
                            totalprice += 150000;
                ...
                if(count == 7){
                    document.getElementById('notvalid').innerHTML="Maximun seat select 6";
                    return false;
                }
                else{
...
<form action="payment.php" method="post">
    <div class="container">
        ...
        <div class="seatCharts-container">
            ...
            <div class="seat_type">Silver : 100.000 VND</div>
        ...
        <div class="row">
            ...
            <div class="seat_type">Gold : 150.000 VND</div>
        ...
        <div class="row">
            ...
            <div class="seat_type">Platinum : 200.000 VND</div>
        ...
        <div class="col-lg-6">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" id="selectedtext" name="seats" placeholder="Selected Seats" disabled></td>
                </tr>
                <tr>
                    <td width="50%"><font color="blue" size="5px"style="font-family: Shruti;">Total Seat:</font></td>
                    <td><input type="text" id="count" name="totalseat" placeholder="Total Seats"></td>
                </tr>
                <tr>
                    <td width="50%"><font color="blue" size="5px"style="font-family: Shruti;">Total Price:</font></td>
                    <td><input type="text" id="price" name="totalprice" placeholder="0 VNĐ" disabled></td>
                </tr>  
